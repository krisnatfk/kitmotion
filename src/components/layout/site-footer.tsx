    ...
    <footer className="bg-sport-black py-section text-white">
      <Container>
        <div className="grid gap-section tablet-narrow:grid-cols-2 desktop-small:grid-cols-[1.5fr_1fr_1fr_1fr]">
          <div><Logo className="text-white" /><p className="mt-lg max-w-xs text-sm leading-relaxed text-white/45">Pelatih olahraga berbasis AI untuk membantu setiap gerakan menjadi lebih baik.</p></div>
